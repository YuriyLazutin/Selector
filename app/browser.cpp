...
void Browser::translateGUI(bool init)
{
  ...
  if (!init)
  {
    Filter.setItemText(0, QCoreApplication::translate("Selector->Browser->Filter", "My objects", "Filter item"));
    Filter.setItemText(1, QCoreApplication::translate("Selector->Browser->Filter", "My invalid objects", "Filter item"));
    Filter.setItemText(2, QCoreApplication::translate("Selector->Browser->Filter", "All objects", "Filter item"));
    Filter.setItemText(3, QCoreApplication::translate("Selector->Browser->Filter", "All system objects", "Filter item"));
    Filter.setItemText(4, QCoreApplication::translate("Selector->Browser->Filter", "All non-system objects", "Filter item"));
    Filter.setItemText(5, QCoreApplication::translate("Selector->Browser->Filter", "All objects modified today", "Filter item"));
  }
